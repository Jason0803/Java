...
import broker.three.server.Database;
	...
	*/
	...
	//==================================================================
		...
		*argument�� ���� CustomerRec[]�� stockList�� �ϳ��� �ѷ��ش�.<BR>
		 ...
		 */    
		public void showCustomer() throws RecordNotFoundException, SQLException{
		 ...
		 * @throws RecordNotFoundException 
		 */   
		public void sellStock() throws RecordNotFoundException, SQLException{
			String ssn = ssnTf.getText().trim();
