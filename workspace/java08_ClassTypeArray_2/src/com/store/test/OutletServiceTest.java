...
public class OutletServiceTest {
	public static void main(String[] args){
		...
		for(int i = 0; i < customers.length; i++){
			Product[] temp = service.getAllProductsOfCustomer(customers[i]);
			System.out.println(" ========== Prices over 10000 of " + customers[i].getCustomerName() + " ========== ");
		...
		for(int i = 0; i < customers.length; i++){
			System.out.print("- Most Expensive for " + customers[i].getCustomerName() + " : " );
			System.out.println("Price = " + service.getMostExpensivePrice(customers[i]));
